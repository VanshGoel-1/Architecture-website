...
const allProjects = [
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1600596542815-2a4d04792395?q=80&w=1200&auto=format&fit=crop"
    },
    {
        id: 3,
        title: "Azure Bay",
        ...
        image: "https://images.unsplash.com/photo-1511818966892-d7a6701b4e8d?q=80&w=1200&auto=format&fit=crop"
    },
    {
        id: 4,
        ...
        <div className={styles.page}>
            ...
            <section className={styles.hero}>
                <div className={styles.heroOverlay}>
                    ...
                    >
                        Crafting Landmarks, One Project<br />at a Time
                    </motion.h1>
            ...
            <section className={styles.content}>
                <div className={styles.intro}>
                    <h2 className={styles.introHeading}>
                        Explore top real estate<br />projects with key<br />insights and visuals.
                    </h2>
                </div>
